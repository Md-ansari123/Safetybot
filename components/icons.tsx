...
export const BotIcon: React.FC<BotIconProps> = (props) => {
    ...
    const themes = {
        emerald: {
            glow: 'rgb(52, 211, 153)',
            glowStop: 'rgb(16, 185, 129)',
            stroke: 'rgba(110, 231, 183, 0.7)',
            circuit: 'rgba(52, 211, 153, 0.3)',
            eyebrow: 'rgba(110, 231, 183, 0.9)',
            eye: 'rgb(110, 231, 183)',
            mouth: 'rgb(110, 231, 183)',
            thinkingFrom: 'rgba(52, 211, 153, 0.4)',
            thinkingTo: 'rgba(110, 231, 183, 0.9)'
        },
        sapphire: {
            glow: 'rgb(96, 165, 250)',
            glowStop: 'rgb(59, 130, 246)',
            stroke: 'rgba(147, 197, 253, 0.7)',
            circuit: 'rgba(96, 165, 250, 0.3)',
            eyebrow: 'rgba(147, 197, 253, 0.9)',
            eye: 'rgb(147, 197, 253)',
            mouth: 'rgb(147, 197, 253)',
            thinkingFrom: 'rgba(96, 165, 250, 0.4)',
            thinkingTo: 'rgba(147, 197, 253, 0.9)'
        },
        ruby: {
            glow: 'rgb(248, 113, 113)',
            glowStop: 'rgb(239, 68, 68)',
            stroke: 'rgba(252, 165, 165, 0.7)',
            circuit: 'rgba(248, 113, 113, 0.3)',
            eyebrow: 'rgba(252, 165, 165, 0.9)',
            eye: 'rgb(252, 165, 165)',
            mouth: 'rgb(252, 165, 165)',
            thinkingFrom: 'rgba(248, 113, 113, 0.4)',
            thinkingTo: 'rgba(252, 165, 165, 0.9)'
        },
    };
        ...
        >
            <style>
                {`
                    ...
                    .bot-avatar.is-thinking .circuit-lines, .bot-avatar.is-focused .circuit-lines {
            ...
            {/* Main Head Shape */}
            <path
                d="M50,10 C77.6,10 100,32.4 100,60 C100,87.6 77.6,110 50,110 C22.4,110 0,87.6 0,60 C0,32.4 22.4,10 50,10 Z"
            ...
            {/* Inner details / circuits */}
            <path
                d="M30 40 Q 50 50, 70 40 M35 50 Q 50 60, 65 50 M40 60 Q 50 70, 60 60"
                fill="none"
                stroke={currentTheme.circuit}
                strokeWidth="0.5"
            ...
            {/* Eyebrows */}
            <path
                d="M32 36 Q 38 33, 44 36"
                stroke={currentTheme.eyebrow}
                strokeWidth="1.5"
                strokeLinecap="round"
                fill="none"
            ...
            {/* Mouth/Speech Indicator */}
            <path
                d="M40 70 Q 50 72, 60 70"
                stroke={currentTheme.mouth}
                strokeWidth="1.5"
                strokeLinecap="round"
                fill="none"
                className="mouth"
